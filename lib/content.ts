...
export interface SiteContent {
  ...
  articles: { title: string; category: string; excerpt?: string; readTime: string; date: string }[];
  faq: { q: string; a: string }[];
  contact: { title: string; intro: string; formName: string; formEmail: string; formMessage: string; formSubmit: string };
}

const DEFAULTS: SiteContent = {
  site: { name: "Loom", title: "Cift ve Aile Terapisti", email: "merhaba@ornekterapist.com", address: "Istanbul", copyright: "Tum haklari saklidir." },
  home: { badge: "LOOM", headline: "Iki iplik,", headlineAccent: "bir desen", headlineSuffix: ".", description: "Cift ve aile terapisinde iliskilerin yeniden orulmesine eslik ediyorum.", cta: "Iletisime Gecin", cardTitle: "Birlikte Orulen", cardSubtitle: "Iliski ve Cift Terapisi", quote: "Kilim iki iplikle dokunur.", quoteAuthor: "Anadolu Dokuma Gelenegi" },
  services: [{ title: "Cift Terapisi", desc: "Tekrarlayan catisma donguleri ve duygusal bagin yeniden dokunmasi.", duration: "75 dk", method: "Gottman / EFT" }],
  about: { title: "Hakkinda", intro: "Bir kilim ustasi iplikleri zorla ayni renge boyamaz.", credentials: [{ year: "-", title: "Klinik psikoloji temeli", detail: "Lisans ve yuksek lisans" }] },
  approach: { title: "Terapi Yaklasimim", intro: "Her iliski, iki farkli hikayenin bir araya gelmesiyle olusur.", principles: [{ title: "Donguyu haritalamak", desc: "Ilk seanslarda tekrarlayan catisma dongusu birlikte cizilir." }] },
  articles: [{ title: "Kavga degil, dongu", category: "Iliski", readTime: "7 dk", date: "" }],
  faq: [{ q: "Partnerim gelmek istemiyor - tek basima gelsem olur mu?", a: "Evet. Degisim cogu zaman tek kisinin farkli bir ilmek atmasiyla baslar." }],
  contact: { title: "Iletisim", intro: "Cift olarak da tek basiniza da yazabilirsiniz.", formName: "Adiniz", formEmail: "E-posta", formMessage: "Mesajiniz", formSubmit: "Ilmegi At" },
};
